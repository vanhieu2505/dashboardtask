    ...
    render() {
        return (
            <div className="active-create-board">
                ...
                <div>
                    <button className="board-cancel-button" onClick={this.cancelBoard.bind(this)}>Cancel</button>
                    <button className="board-create-button" onClick={this.createBoard.bind(this)}>Create</button>
                </div>
            </div>            
        );
    }
...
export default connect(null, { cancelNewBoard, addNewBoard })(ActiveCreateBoard);